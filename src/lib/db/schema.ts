...
export const invoices = mysqlTable('invoices', {
  ...
  status: varchar('status', { length: 20 }).$type<'draft' | 'sent' | 'paid' | 'partially_paid' | 'overdue' | 'cancelled'>().default('draft').notNull(),
  ...
  discountValue: varchar('discount_value', { length: 50 }).default('0'),
  discountAmount: varchar('discount_amount', { length: 50 }).default('0'),
  amountPaid: varchar('amount_paid', { length: 50 }).default('0').notNull(),
  notes: text('notes'),
